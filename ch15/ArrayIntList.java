public class ArrayIntlist {
  ...
  // pre: 0 <= index < size()
  // post: return the integer at the given index in the list
  ...
  // post: return the position of the first occurrence of the give value
  // (-1 if not found)
